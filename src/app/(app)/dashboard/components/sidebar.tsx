...
export default function DashboardSidebar({ isOpen, onClose }: Props) {
  ...
  return (
    <>
      ...
      <aside
        className={`flex flex-col w-64 fixed left-0 top-0 bottom-0 z-40 bg-surface-elevated backdrop-blur-xl border-r border-border shadow-lg pb-6 transition-transform duration-300 ease-in-out lg:translate-x-0 lg:top-16 ${
      ...
      >
        ...
        <div className="px-6 mt-6 lg:mt-10 mb-10">
          <CreateTripDialog
            trigger={
              <button className="w-full bg-secondary hover:bg-on-secondary-container text-white py-4 px-6 rounded-xl flex items-center justify-center gap-2 text-sm font-semibold transition-all active:scale-95 shadow-md">
