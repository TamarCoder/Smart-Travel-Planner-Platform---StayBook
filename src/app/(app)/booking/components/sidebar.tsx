...
export default function BookingSidebar({ isOpen, onClose }: Props) {
  return (
    <>
      ...
      <aside
        className={`flex flex-col w-64 fixed left-0 top-0 bottom-0 z-40 bg-white/80 backdrop-blur-xl border-r border-white/20 shadow-lg transition-transform duration-300 ease-in-out lg:translate-x-0 lg:pt-16 ${
