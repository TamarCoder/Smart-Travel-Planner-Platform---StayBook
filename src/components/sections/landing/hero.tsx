    ...
    <section className="relative min-h-150 sm:min-h-187.5 md:min-h-230.25 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-8 md:px-12 text-center py-20 md:py-0">
        ...
        >
          ...
          <button className="w-full flex items-center justify-center gap-2 py-3.5 bg-secondary hover:bg-on-secondary-container text-white rounded-2xl text-sm font-semibold transition-all">
        ...
        >
          ...
          <button className="flex items-center gap-2 px-7 py-3 bg-secondary hover:bg-on-secondary-container text-white rounded-full text-sm font-semibold transition-all hover:shadow-lg hover:-translate-y-px whitespace-nowrap">
            <Search className="h-4 w-4" />
            Search
          </button>
        </div>
